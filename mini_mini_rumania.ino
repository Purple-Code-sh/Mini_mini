    ...
    switch (lineState) {
      case 41:
        ...
        switch (sensorState) {
          ...
          case 2:  //DETECTA SENSOR ENFRENTE DERECHA.
            Serial.println("caso  2");
            derecha(80, 80); //gira con muy poca potencia a la derecha
            yaSensoEnfrente = 0;
            break;

          case 1: //DETECTA SENSOR ENFRENTE IZQUIERDA.
            Serial.println("caso 1 ");
            izquierda(80, 80); //gira con poca potencia a la izquierda
            yaSensoEnfrente = 0;
            break;
          ...
          case 5: //DETECTA ENFRENTE DERECHA Y DERECHA.
            ...
            derecha(170, 170); //gira con poca potencia a la derecha
            yaSensoEnfrente = 0;
            break;

          case 8: //DETECTA SOLO SENSOR IZQUIERDO
            Serial.println("caso  8");
            izquierda(90, 90); //gira casi full a la izquierda
            yaSensoEnfrente = 0;
            break;

          case 10:  //DETECTA ENFRENTE IZQUIERDA E IZQUIERDA.
            Serial.println("caso  10");
            izquierda(170, 170); //gira con poca potencia a la izquierda
            yaSensoEnfrente = 0;
            break;
          ...
          default:
            Serial.println("yyyyy"); //NO DETECTA yyyyyyyy
